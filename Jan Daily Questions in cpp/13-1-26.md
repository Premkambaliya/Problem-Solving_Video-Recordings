...
## Problem Description
You are given an array of axis-aligned squares where each square is represented by coordinates [x, y, size]. Find the horizontal line that separates the squares into two equal area halves.
