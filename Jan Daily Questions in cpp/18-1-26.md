...
## Problem Description
A magic square is a k x k grid filled with integers such that every row sum, column sum, and both diagonal sums are all equal. Find the size of the largest magic square in the given grid.
