...
## Problem Description
You are given an array of axis-aligned squares. Find the horizontal line that separates the squares into two equal area halves using sweep line algorithm.
